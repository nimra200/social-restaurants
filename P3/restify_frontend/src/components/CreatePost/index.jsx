...
export default function CreatePost(){
    ...
    const submitHandler = (event) => {
        ...
        fetch('http://localhost:8000/restaurants/create-blog-post/',
            ...
            .then(data => {
                if (data) {
                    navigate(`/restaurants/${data.restaurant_id}/posts/view`)
                }
            })
    }
        ...
        <form onSubmit={submitHandler} encType="multipart/form-data">
            <div style={{padding: "2%", backgroundColor : "white"}} className="container">
                ...
                <div className="row" style={{paddingTop: "2%"}}>
                    <label htmlFor="file">Attach media to blog post
                ...
                <div className="row" style={{paddingTop: "2%"}}>
                    <label htmlFor="topic" style={{alignItems: "center"}} >Topic:
                ...
                <div className="row">
                    ...
                    <label htmlFor="description">Blog entry:
